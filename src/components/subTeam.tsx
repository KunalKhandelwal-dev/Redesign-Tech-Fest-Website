...
import teamData from "../data/sub.json"; // ✅ Import team details from JSON
...
<h2 className="text-4xl md:text-5xl lg:text-6xl font-orbitron mb-6">
  Meet the <span className="gradient-text">Subcommittee</span>
</h2>

<p className="text-lg text-gray-400 max-w-3xl mx-auto">
  Dedicated members collaborating passionately to ensure{" "}
  <span className="text-cyan-400 font-medium">
    YUGANTRAN 2.0 (2025)
  </span>{" "}
  is a remarkable success.
</p>
{/* Dedicated members collaborating passionately to ensure YUGANTRAN 2.0 (2025) is a remarkable success. */}
        </motion.div>
